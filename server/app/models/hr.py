...
class JobTitle(Base, AuditMixin):
    ...
    company = relationship("Company", foreign_keys=[company_id], back_populates="job_titles")
...
class Department(Base, AuditMixin):
    ...
    company = relationship("Company", foreign_keys=[company_id], back_populates="departments")
...
class WorkType(Base, AuditMixin):
    ...
    company = relationship("Company", foreign_keys=[company_id], back_populates="work_types")
...
class Employee(Base, AuditMixin):
    ...
    location_id = Column(Integer, ForeignKey('company_locations.id'), nullable=True)
    ...
    location = relationship("CompanyLocation", foreign_keys=[location_id], back_populates="employees")
